...
import com.pp.grup.grupapi.Repository.MemberRepository;
...
public class MemberService {
    ...
    private final MemberPicRepository memberPicRepository;
...
//        memberRepository.save(memberEntity);
    ...
    public String getMemberPicURL(Long memberPicId){
        Optional<MemberPicEntity> memberPicEntity= memberPicRepository.findByMemberPicId(memberPicId);
        String memberPicURL=memberPicEntity.get().getMemberPicURL();
        return memberPicURL;
    }
